// VidiatorWMSourceReader.cpp : Defines the entry point for the DLL application.
//
...
{
    &CLSID_WMSourceReader,					// CLSID of filter
    L"Vidiator WMSourceReader Filter",		// Filter's name
...
CFactoryTemplate g_Templates []  = {
    { L"VidiatorWMSourceReader"
    , &CLSID_WMSourceReader
    , CreateInstance<CVidiatorWMSourceReaderFilter>
    , NULL
    , &sudFilterInfo }
};
